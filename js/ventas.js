...
$.ajax({
    ...
    url: "https://ultravioleta.netlify.app/apis/carshop/rates",
...
$.ajax({
    ...
    url: "https://ultravioleta.netlify.app/apis/carshop/brands",
    success: function(data) {
...
$("#select-brand").on("change", function() {
    ...
    //var url = "/json/models.json?brand=" + salesApp.brandSelected;
...
function loadCars() {
    ...
    $.ajax({
        ...
        url: "https://ultravioleta.netlify.app/apis/carshop/cars?year=" + year + "&brand=" + brand + "&model=" + model + "&status=" + status,
        success: function(data) {
